...
class ExprListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExprParser#logic_operator.
    def enterLogic_operator(self, ctx:ExprParser.Logic_operatorContext):
        pass

    # Exit a parse tree produced by ExprParser#logic_operator.
    def exitLogic_operator(self, ctx:ExprParser.Logic_operatorContext):
        pass
